...
export const MAP_LATLNG_BOUNDS: LatLngBoundsLiteral = [[-60, -160], [75, 200]];

type CountryDataType = {
  name: string;
  aliases: string[];
  markerLatLng: LatLngTuple;
};

export const COUNTRY_DATA: CountryDataType[] = [
...
export const ALIAS_TO_COUNTRY: Map<string, string> = (() => {
